  ...
  return (
    <div className="min-h-screen p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header skeleton */}
        <div className="mb-6">
          <div className="h-10 w-64 bg-[var(--sky-200)] border-3 border-outline shadow-[3px_3px_0_var(--outline-black)] rounded-lg mb-4 animate-pulse motion-reduce:animate-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {[
            ...
            <div
              key={i}
              className="bg-card border-4 border-outline shadow-[4px_4px_0_var(--outline-black)] rounded-xl p-6"
            >
        ...
        <div className="bg-card border-4 border-outline shadow-[4px_4px_0_var(--outline-black)] rounded-xl p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <div className="h-8 w-48 bg-coin/30 border-2 border-outline rounded animate-pulse motion-reduce:animate-none" />
            <div className="h-10 w-32 bg-luigi/30 border-3 border-outline rounded-lg animate-pulse motion-reduce:animate-none" />
          </div>

          {/* Holdings table skeleton */}
          <div className="space-y-3">
            {/* Table header */}
            <div className="grid grid-cols-5 gap-4 pb-3 border-b-3 border-outline">
            ...
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="grid grid-cols-5 gap-4 py-3 border-b-2 border-[var(--sky-200)]">
                ...
                <div className="h-8 w-20 bg-sky/30 border-2 border-outline rounded-lg animate-pulse motion-reduce:animate-none" />
              </div>
            ))}
          </div>
        </div>
