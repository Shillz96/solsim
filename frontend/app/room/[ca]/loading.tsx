    ...
    >
      <div className="text-center space-y-4">
        <div className="relative">
          ...
          <div className="absolute inset-0 h-12 w-12 border-2 border-star/20 border-b-[var(--star-yellow)] rounded-full animate-spin mx-auto" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }} />
        </div>
        <div>
