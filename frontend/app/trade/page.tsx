    ...
    <div className="min-h-screen bg-background">
      <main className="px-2 py-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 min-h-[calc(100vh-5rem)]">
          <aside className="lg:col-span-2 space-y-3 overflow-y-auto lg:sticky lg:top-4 lg:h-[calc(100vh-6rem)]">
            <TokenSearch />
          ...
          <aside className="lg:col-span-2 lg:sticky lg:top-4 lg:h-[calc(100vh-6rem)]">
