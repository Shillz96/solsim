      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="font-heading text-4xl md:text-5xl font-bold">About Sol Sim</h1>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-3">
                  <p className="text-lg leading-relaxed">
                    Sol Sim exists to democratize cryptocurrency trading education by providing a risk-free environment
          ...
          <EnhancedCard className="p-6 border-2">
            <div className="space-y-4 text-muted-foreground">
              ...
              <p className="leading-relaxed">
                ...
                Sol Sim provides the perfect environment to practice and improve your skills.
              </p>
            </div>
          </EnhancedCard>
        </motion.section>
        ...
        >
          ...
          <EnhancedCard className="p-6 border-2">
            <div className="space-y-3">
              <p className="text-muted-foreground leading-relaxed">
                Sol Sim was created by traders who understand the challenges of learning to trade in the fast-paced
          ...
          <EnhancedCard className="p-6 border-2 border-yellow-500/30 bg-yellow-500/5">
            <div className="space-y-3">
              <p className="text-sm text-muted-foreground leading-relaxed">
                <strong className="text-foreground">Sol Sim is a simulator for educational purposes only.</strong> All
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                and risk tolerance. The information provided on Sol Sim is not financial advice.
              </p>
              <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        >
          ...
          <p className="text-muted-foreground">Join thousands of traders practicing on Sol Sim.</p>
          <Link href="/trade">
