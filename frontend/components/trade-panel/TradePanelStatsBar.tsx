  ...
  return (
    <div className="grid grid-cols-4 gap-2">
      ...
      <div className="bg-white border-3 border-outline rounded-[14px] p-3 flex flex-col items-center justify-center shadow-[4px_4px_0_var(--outline-black)] hover:shadow-[5px_5px_0_var(--outline-black)] hover:-translate-y-[1px] transition-all min-w-0">
        ...
        <div className="font-mono font-bold text-xs text-outline truncate w-full text-center" title={`$${bought.toFixed(2)}`}>
      ...
      <div className="bg-white border-3 border-outline rounded-[14px] p-3 flex flex-col items-center justify-center shadow-[4px_4px_0_var(--outline-black)] hover:shadow-[5px_5px_0_var(--outline-black)] hover:-translate-y-[1px] transition-all min-w-0">
        ...
        <div className="font-mono font-bold text-xs text-outline truncate w-full text-center" title={`$${sold.toFixed(2)}`}>
      ...
      <div className="bg-white border-3 border-outline rounded-[14px] p-3 flex flex-col items-center justify-center shadow-[4px_4px_0_var(--outline-black)] hover:shadow-[5px_5px_0_var(--outline-black)] hover:-translate-y-[1px] transition-all min-w-0">
        ...
        <div className="font-mono font-bold text-xs text-outline truncate w-full text-center" title={`$${holdingValue.toFixed(2)}`}>
      ...
      <div className={cn(
        ...
        <div className={cn(
          'font-mono font-bold text-xs truncate w-full text-center',
