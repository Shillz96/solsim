        ...
        <motion.button
          ...
          className={cn(
            ...
            fundingSource === 'DEPOSITED'
              ...
              : 'bg-white border-pipe-900 hover:border-star-yellow-400 shadow-[4px_4px_0_0_rgba(0,0,0,1)]'
          )}
        >
          {/* Icon & Title */}
        ...
        <motion.button
          ...
          className={cn(
            ...
            fundingSource === 'WALLET' && connected
              ...
              : 'bg-white border-pipe-900 hover:border-coin-yellow-400 shadow-[4px_4px_0_0_rgba(0,0,0,1)]'
          )}
        >
          {/* Icon & Title */}
          <div className="flex items-center gap-2">
