    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button
            className={`w-full flex items-center justify-between p-3 bg-card border-3 border-pipe-400 rounded hover:border-mario-red-500 transition-colors ${className}`}
            disabled={isChanging}
          >
        ...
        <DropdownMenuContent
          align="start"
          className="w-[300px] mario-card bg-card border-3 border-pipe-400"
        >
