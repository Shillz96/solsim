  ...
  return (
    <div className="relative" ref={searchContainerRef}>
      ...
      {showResults && results.length > 0 && (
        <Card className="absolute top-full mt-2 w-full z-search-dropdown max-h-80 overflow-y-auto glass-overlay">
      ...
      {showResults && query && !isSearching && results.length === 0 && (
        <Card className="absolute top-full mt-2 w-full z-search-dropdown glass-overlay">
