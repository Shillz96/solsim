    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-mario font-bold text-outline">WALLET MANAGER</h2>
      ...
      >
        ...
        <div className="bg-card/50 border-3 border-dashed border-gray-400 rounded-xl p-6 text-center">
          <div className="text-4xl mb-2">🔜</div>
          <h3 className="text-lg font-mario font-bold text-outline mb-2">TRANSACTION HISTORY</h3>
          <p className="text-sm text-muted-foreground font-bold">Coming soon!</p>
        </div>

        <div className="bg-card/50 border-3 border-dashed border-gray-400 rounded-xl p-6 text-center">
          <div className="text-4xl mb-2">🔜</div>
          <h3 className="text-lg font-mario font-bold text-outline mb-2">WALLET ANALYTICS</h3>
          <p className="text-sm text-muted-foreground font-bold">Coming soon!</p>
        </div>
      </motion.div>
    </div>
