      ...
      >
        <CardContent className="p-6 relative space-y-5">
          ...
          <div className="space-y-4">
            ...
            <div className="text-center py-6 px-4 rounded-lg border-3 border-[var(--outline-black)] bg-white shadow-[3px_3px_0_var(--outline-black)]">
              <div className="text-5xl font-mario leading-none mb-2 text-[var(--outline-black)]">
                {tier.simulatedSol}
              </div>
              <div className="text-[11px] font-bold text-[var(--outline-black)] uppercase tracking-widest">
                Simulated SOL
              </div>
            </div>
            ...
            <div className="text-center space-y-2">
              <div className="flex items-baseline justify-center gap-2">
                <span className="text-4xl font-mario text-[var(--outline-black)]">
                  {tier.realSol}
                </span>
                <span className="text-lg font-bold text-[var(--outline-black)]">
                  SOL
                </span>
              </div>
              <div className="text-xs text-[var(--outline-black)] font-semibold min-h-[20px]">
                {tier.bonus > 0 ? (
          ...
          <div className={cn(
            "text-center text-xs font-mario py-3 px-4 rounded-lg transition-all duration-200 mt-2 border-3 border-[var(--outline-black)]",
            selected
