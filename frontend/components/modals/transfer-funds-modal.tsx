...
export function TransferFundsModal({
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="mario-card bg-white max-w-md border-4 border-pipe-700">
        <DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              disabled={isLoading}
              className="w-full p-3 bg-white border-3 border-pipe-400 rounded text-pipe-900 font-medium hover:border-mario-red-500 focus:border-mario-red-500 focus:outline-none transition-colors"
            >
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full p-3 bg-white border-3 border-pipe-400 rounded text-pipe-900 font-medium hover:border-luigi-green-500 focus:border-luigi-green-500 focus:outline-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
