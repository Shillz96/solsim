...
export function BottomNavBar({ className }: BottomNavBarProps = {}) {
  ...
  return (
    <>
      {/* Mobile Bottom Nav */}
      <nav className={cn(
        "fixed bottom-0 left-0 right-0 z-50 border-t-4 border-outline-black bg-[#FFFAE9] opacity-95 shadow-[0_-4px_0_0_rgba(28,28,28,1)] md:hidden",
        className
      )}>
      ...
      <div className={cn(
        "hidden md:block fixed bottom-0 left-0 right-0 z-40 border-t-4 border-outline-black bg-[#FFFAE9] opacity-95 shadow-[0_-4px_0_0_rgba(28,28,28,1)]",
        className
      )}>
